      ...
      <div className="max-w-md w-full space-y-8 text-center">
        {isVerified ? (
          <div>
            ...
            <div className="mt-4">
              <div className="inline-block border-4 border-green-600 border-t-transparent rounded-full w-12 h-12 animate-spin" />
            </div>
          </div>
        ) : (
          <>
              ...
              <div className="rounded-md bg-red-50 p-4">
                <div className="flex items-center">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-5a1 1 0 112 0 1 1 0 01-2 0zm.293-7.707a1 1 0 011.414 0l2 2a1 1 0 01-1.414 1.414L11 8.414V13a1 1 0 11-2 0V8.414l-.293.293a1 1 0 01-1.414-1.414l2-2z"
                      clipRule="evenodd"
                    />
                  </svg>
